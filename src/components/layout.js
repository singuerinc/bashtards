    ...
    <div>
      <nav className="list mt4 pa0 flex justify-center">
        <a
          href="/"
          target="_self"
          className="link dim dib light-silver pa0 mr2"
        >
          All
        </a>
        <a
  ...
  return (
    <div className="sans-serif dark-gray mh4 mh3 mw-100 mw7-l center-l">
      ...
      <footer className="tc mv4">
        <h3 className="f6 fw4 silver ma0 mt1">
          Written by{" "}
          <a
            className="link dim silver"
            href="https://twitter.com/singuerinc"
            target="_blank"
          >
            Nahuel
          </a>{" "}
          and Ricardo, who are always disappointed with their setups.
        </h3>
