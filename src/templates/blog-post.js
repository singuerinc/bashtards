    ...
    <Layout>
      <article>
        ...
        <header className="mb4">
          ...
          <h1 className="f1 fw2 mv1 db green">{post.frontmatter.title} </h1>
        ...
        <sections>
          ...
          <div className="flex justify-center pv3">
            <a
              className="dib link dim dark-gray mr3 tr"
              href={`https://www.facebook.com/sharer/sharer.php?u=${shareTxt}`}
              target="_blank"
            ...
            <a
              className="dib link dim dark-gray ml3 tl"
              href={`https://twitter.com/home?status=${shareTxt}`}
              target="_blank"
              rel="noopener noreferrer"
            >
              <span
